...
from django.forms import BooleanField, CharField, DateTimeField, FloatField, \
                         IntegerField, ModelForm, ChoiceField, ValidationError, ModelMultipleChoiceField
...
class BaseDynamicEntityForm(ModelForm):
    ...
    FIELD_CLASSES = {
        ...
        'bool': BooleanField,
        'enum': ChoiceField,
        'multi': ChoiceField, #ModelMultipleChoiceField,
    }
    ...
    def _build_dynamic_fields(self):
        ...
        for attribute in self.entity.get_all_attributes():
            ...
            if datatype == attribute.TYPE_ENUM or datatype == attribute.TYPE_MULTI:
            ...
            if value and not (datatype == attribute.TYPE_ENUM or datatype == attribute.TYPE_MULTI): #enum done above
    ...
    def save(self, commit=True):
        ...
        for attribute in self.entity.get_all_attributes():
            ...
            if attribute.datatype == attribute.TYPE_MULTI:
                if value:
